...
..  only:: draft
    ...
    - :file:`cvrp_data_generator.h`: This file contains the ``CVRPDataGenerator`` class that generates random CVRP instances.
    - :file:`cvrp_data_generator.cc`: A little program to generate random CVRP instances.
    - :file:`cvrp_data.h`: This file contains the ``CVRPData`` class used in this chapter to encode a CVRP instance.
    - :file:`cvrp_solution.h`: This file provides the ``CVRPSolution`` used to represent CVRP solutions.
    - :file:`cvrp_epix_data.h`: This file provides the helper functions to visualize CVRP solutions with the ePiX library.
    - :file:`vrp_solution_to_epix.cc`: Allows to visualize a VRP solution with the help of the ePiX library.
    ...
    - :file:`cvrp_solution_to_epix.cc`: Allows to visualize a CVRP solution with the help of the ePiX library.
