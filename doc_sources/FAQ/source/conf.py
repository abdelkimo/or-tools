...
pngmath_latex_preamble = "\usepackage{color}"
...
html_sidebars = {
	'**': ['sidetitle.html','mysearchbox.html','welcome.html','examples.html','myglobaltoc.html'],
}
...
latex_documents = [
  ('index', 'FAQ.tex', u'Frequently Asked Questions',
   u'Google', 'faq'),
]
...
latex_additional_files = ['images/logo.pdf', 'images/google.pdf', 'images/dialog-warning.pdf']
# -- Options for manual page output --------------------------------------------

# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [
    ('index', 'Frequently Asked Questions', u'Google',
     [u'Google'], 1)
]
