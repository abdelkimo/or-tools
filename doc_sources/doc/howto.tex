...
(Sphinx does provide some tools but... check again to see if they fit your needs).
 ...
 \item[Step \raisebox{.3pt}{\textcircled{\raisebox{-.9pt} {7}}}] {\bf Update the documentation source:} (script: none)\\If you're happy with the new documentation, commit your changes on the Google solvers. Step~\raisebox{.3pt}{\textcircled{\raisebox{-.9pt} {7}}} can be done after step~\raisebox{.3pt}{\textcircled{\raisebox{-.9pt} {9}}}.
