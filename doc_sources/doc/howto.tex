...
\subsection{Content of the documentation}
\label{doc_content}

Everything is explained on the documentation hub.
...
\begin{description}
 ...
 \item[Step \raisebox{.3pt}{\textcircled{\raisebox{-.9pt} {3}}}] {\bf Generate the documentation:} (script: \code{generate.py})\\Generate automatically the documentation. 
 \item[Step \raisebox{.3pt}{\textcircled{\raisebox{-.9pt} {1}}}] {\bf Deploy the documentation:} (script: \code{deploy.py})\\Copy locally the generated output files in the directory DEPLOY. See section~\ref{deploy_documentation} to understand why.
 \item[Step \raisebox{.3pt}{\textcircled{\raisebox{-.9pt} {1}}}] {\bf Check the documentation:} (script: \code{check.py})\\Check the documentation without messing with the SVN tree. See section~\ref{check_documentation}.
 \item[Step \raisebox{.3pt}{\textcircled{\raisebox{-.9pt} {1}}}] {\bf Update the version:} (script: \code{version.py})\\If you're happy with the new documentation, update the new version number and keep the old one. See section~\ref{update_version}.
 \item[Step \raisebox{.3pt}{\textcircled{\raisebox{-.9pt} {1}}}] {\bf Commit your changes in the source files:} (script: none)\\. Commit your changes. See section~\ref{commit_source_files}.
 \item[Step \raisebox{.3pt}{\textcircled{\raisebox{-.9pt} {1}}}] {\bf Prepare the documentation:} (script: \code{prepare.py})\\Prepare the documentation to be uploaded. See section~\ref{prepare_documentation}.
 \item[Step \raisebox{.3pt}{\textcircled{\raisebox{-.9pt} {1}}}] {\bf Upload the documentation:} (script: \code{upload.py})\\Upload the generated output files on the Google servers. See
 section~\ref{upload_documentation}.
\item[Step \raisebox{.3pt}{\textcircled{\raisebox{-.9pt} {1}}}] {\bf Upload the documentation:} (script: \code{upload.py})\\Upload the generated output files on the Google servers. See
\end{description}

\raisebox{.3pt}{\textcircled{\raisebox{-.9pt} {9}}}
